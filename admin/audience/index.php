			...
			<table class="table tabe-hover table-bordered" id="list">
				...
				<tbody>
					...
					<tr>
						...
						<td><b><?php echo ucwords($row['name']) ?></b> <span><a href="javascript:void(0)" class="view_data" rel = "<?php echo $row['qrcode_value'];?>" data-id="<?php echo $row['id'] ?>"><span class="fa fa-qrcode"></span></a></span></td>
						<td>
