              ...
              <div class="os-content" style="padding: 0px 8px; height: 100%; width: 100%;">
                ...
                <nav class="mt-2">
                   <ul class="nav nav-pills nav-sidebar flex-column nav-flat" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item">
                      <a href="<?php echo base_url ?>admin/?page=student" class="nav-link nav-audience">
                    ...
                    <li class="nav-item">
                      <a href="<?php echo base_url ?>admin/?page=faculty" class="nav-link nav-list">
                    ...
                    <li class="nav-item">
                      <a href="<?php echo base_url ?>admin/?page=class" class="nav-link nav-classes">
