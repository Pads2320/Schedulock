...
$class_schedule_id = "CLASS_SCHEDULE_".$date_time_value."_".generate_qrcode_value(35);
...
<form action="" id="event-frm">
		...
		<small><i>Specify a time range per day, Select available day of the week only</i></small>
			...
			<div class = "row mt-2">
				...
				<div class="col-md-4">
					...
					<div class="icheck-primary">
						<input type="checkbox" id="monday_sched" value="1">
				...
				<div class="col-md-4">
					<small>From</small>
					<input type = "time" id = "time_start_monday"/>
				</div>
				<div class="col-md-4">
					<small>To</small>
					<input type = "time" id = "time_end_monday"/>
				</div>
			...
			<div class = "row mt-2">
				...
				<div class="col-md-4">
					...
					<div class="icheck-primary">
						<input type="checkbox" id="tuesday_sched" value="1">
				...
				<div class="col-md-4">
					<small>From</small>
					<input type = "time" id = "time_start_tuesday"/>
				</div>
				<div class="col-md-4">
					<small>To</small>
					<input type = "time" id = "time_end_tuesday"/>
				</div>
			...
			<div class = "row mt-2">
				...
				<div class="col-md-4">
					...
					<div class="icheck-primary">
						<input type="checkbox" id="wednesday_sched" value="1">
				...
				<div class="col-md-4">
					<small>From</small>
					<input type = "time" id = "time_start_wednesday"/>
				</div>
				<div class="col-md-4">
					<small>To</small>
					<input type = "time" id = "time_end_wednesday"/>
				</div>
			...
			<div class = "row mt-2">
				...
				<div class="col-md-4">
					...
					<div class="icheck-primary">
						<input type="checkbox" id="thursday_sched" value="1">
				...
				<div class="col-md-4">
					<small>From</small>
					<input type = "time" id = "time_start_thursday"/>
				</div>
				<div class="col-md-4">
					<small>To</small>
					<input type = "time" id = "time_end_thursday"/>
				</div>
			...
			<div class = "row mt-2">
				...
				<div class="col-md-4">
					...
					<div class="icheck-primary">
						<input type="checkbox" id="friday_sched" value="1">
				...
				<div class="col-md-4">
					<small>From</small>
					<input type = "time" id = "time_start_friday"/>
				</div>
				<div class="col-md-4">
					<small>To</small>
					<input type = "time" id = "time_end_friday"/>
				</div>
			...
			<div class = "row mt-2">
				...
				<div class="col-md-4">
					...
					<div class="icheck-primary">
						<input type="checkbox" id="saturday_sched" value="1">
				...
				<div class="col-md-4">
					<small>From</small>
					<input type = "time" id = "time_start_saturday"/>
				</div>
				<div class="col-md-4">
					<small>To</small>
					<input type = "time" id = "time_end_saturday"/>
				</div>
			...
			<div class = "row mt-2">
				...
				<div class="col-md-4">
					...
					<div class="icheck-primary">
						<input type="checkbox" id="sunday_sched" value="1">
				...
				<div class="col-md-4">
					<small>From</small>
					<input type = "time" id = "time_start_sunday"/>
				</div>
				<div class="col-md-4">
					<small>To</small>
					<input type = "time" id = "time_end_sunday"/>
				</div>
	...
	<div class="form-group">
		...
		<div class = "row mt-2">
			...
			<div class="col-md-5">
				<small>From</small>
				<input type = "date" id = "date_start_sched"/>
			</div>
			<div class="col-md-4">
				<small>To</small>
				<input type = "date" id = "date_end_sched"/>
			</div>
